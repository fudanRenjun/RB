...
model = KNeighborsClassifier(n_neighbors=5,
                 weights='uniform', algorithm='auto', leaf_size=15,
                 p=2)  # 选择邻居数量，这里选取 10 个邻居作为示例
...
plt.savefig('E:/RS/LBL/KNN70%-ROC.pdf', bbox_inches='tight', pad_inches=0)
plt.show()
...
plt.legend(loc="lower right")
plt.savefig('E:/RS/LBL/KNN70%-PR.pdf', bbox_inches='tight', pad_inches=0)
plt.show()