...
plt.savefig('E:/RS/LBL/RF70%-ROC.pdf', bbox_inches='tight', pad_inches=0)
plt.show()
...
plt.legend(loc="lower right")
plt.savefig('E:/RS/LBL/RF70%-PR.pdf', bbox_inches='tight', pad_inches=0)
plt.show()

from joblib import dump
dump(model, 'E:/RS/LBL/LBL.pkl')